...
WeakAuras has been around for years now, and there is an entire [ecosystem](https://wago.io/) built around it. One of the tools, an Electron / Vue "package manager" app called [WeakAuras Companion](https://weakauras.wtf), I actually contributed to back in it's early days.
...
Just for fun, here's the final 1.5 minutes of top team Limit achieveing a world first final boss kill last year.  If you watch closely, you'll notice a *lot* of WeakAuras on the screens of the featured players.
