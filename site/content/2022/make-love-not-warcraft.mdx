...
<Callout variant="danger">
  ...
  **These examples are not intended to serve as a WeakAuras tutorial**.  I've intentionally changed things and left things out to make this all easier to understand.  
