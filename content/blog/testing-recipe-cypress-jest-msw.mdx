...
```js title="src/test/mocks/data.js"
export const dogs = [
  {
    id: 1,
    name: 'Milo',
...
```js title="src/test/mocks/handlers.js"
...
```js title="src/test/mocks/server.js"
...
```js title="src/test/mocks/browser.js"
import { setupWorker } from 'msw'
...
```js title="cypress/integration/App.test.js"
...
```diff title="src/test/mocks/browser.js"
import { setupWorker } from 'msw'
...
```diff title="cypress/integration/App.test.js"
